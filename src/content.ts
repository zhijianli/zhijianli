...
const zh: SiteCopy = {
  ...
  counseling: {
    trainingTitle: "专业培训",
    training: [
      "2013-2015 年参加杭州德瑞姆国家心理咨询师培训两年，2015年持有国家三级心理咨询师证书（编号：1503000210300408）。",
      "2016 年参与香港精神分析家苏伟峰教授的拉康派心理学培训一年，并合作发表论文集《凝定与变迁》。",
    ],
    practiceTitle: "实务经验",
    practice: [
      "2015 年开始个人体验，累计 100+ 小时。",
...
const en: SiteCopy = {
  ...
  ui: {
    ...
    tryNow: "Try it",
    faqLabel: "FAQ",
    faqTitle: "About Mocui, what other questions are there?",
